# IO.Swagger - the C# library for the test
...
------------ | ------------- | ------------- | -------------
*DefaultApi* | [**CompactGet**](docs/DefaultApi.md#compactget) | **GET** /compact | 
*WeatherApi* | [**GetStatus**](docs/WeatherApi.md#getstatus) | **GET** /status | 
